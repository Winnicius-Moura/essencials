export class ArrayUtils {
  ...
  static generatePaymentMethodOptions(size: number): string[] {
...
export class ValueUtils {
  ...
  static calculateSubtotalWithDiscount = (value: number, quantity: number, discount: number | null | undefined) => {
...
export class CookieUtils {
  static setCookie(cookieData: { [key: string]: string }, days: number): void {
...
export class CommonUtils {
  ...
  static exportToCSV = (bodyList: any[]): void => {
    if (!bodyList.length) return;

    const quoteIfNeeded = (value: any): any => {
